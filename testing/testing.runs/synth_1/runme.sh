...
HD_PWD='C:/Users/alexg/Bureau/VHDL/testing/testing.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Songs.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Songs.tcl
