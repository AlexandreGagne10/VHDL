...
HD_PWD='C:/Users/alexg/Bureau/VHDL/testing/testing.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Songs.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Songs.tcl -notrace
